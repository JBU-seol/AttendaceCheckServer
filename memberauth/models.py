...
class logTable(models.Model):
    ...
    lecture_id = models.CharField(max_length=8)
    one_week = models.IntegerField(default=0)
    two_week = models.IntegerField(default=0)
    three_week = models.IntegerField(default=0)
    four_week = models.IntegerField(default=0)
    five_week = models.IntegerField(default=0)
    six_week = models.IntegerField(default=0)
    seven_week = models.IntegerField(default=0)
    eight_week = models.IntegerField(default=0)
    nine_week =models.IntegerField(default=0)
    ten_week = models.IntegerField(default=0)
    eleven_week = models.IntegerField(default=0)
    twelve_week = models.IntegerField(default=0)
    thirteen_week = models.IntegerField(default=0)
    fourteen_week = models.IntegerField(default=0)
    fifteen_week = models.IntegerField(default=0)
    sixteen_week = models.IntegerField(default=0)
